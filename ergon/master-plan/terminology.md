...
- The terminology document is the SSOT for all project-related terms and definitions used in the codebase and documents.
- Read the terminology document (ergon/master-plan/terminology.md) before starting any work.
...
- Refer to and update the terminology document as needed.
